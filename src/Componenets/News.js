...
export class News extends Component {
  ...
  async UpdateNews() {
    ...
    const url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=676b3d48cdf043a9b520dc700f1e4cd5&page=${this.state.page}&pageSize=${this.props.pageSize}`;
